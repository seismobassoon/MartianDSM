...
c ---------------------------<< constants >>---------------------------
      ...
      parameter ( maxnlay = 180880 )
      parameter ( maxnslay = 148840 )
      parameter ( maxnllay = 132040 )
      parameter ( maxnzone = 220 )
      parameter ( maxnr = 500 )
...
c variable for the trial function
      ...
      complex*16 bvec(3,-2:2,maxnr),rdvec(1:3,-2:2)
...
c variable for the source
      integer spn,ns
      real*8 r0,mt(3,3),spo,eqlat,eqlon,singleforce(3)
